        ...
        <div className="experience-layout">
          <aside className="experience-photo-card">
            ...
            <div className="relative z-10 flex h-full flex-col justify-end p-6 text-white">
              ...
              {topRated ? <p className="mt-5 text-sm leading-6 text-white/85">Mejor evaluación base: <span className="font-bold text-white">{topRated.name}</span> · {topRated.rating.toFixed(1)}</p> : null}
            </div>
          </aside>
