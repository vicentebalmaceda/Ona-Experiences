    ...
    <header className="fixed inset-x-0 top-0 z-[1000] border-b border-white/10 bg-slate-950/70 backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
        ...
        <nav className="hidden items-center gap-6 text-sm text-slate-200 md:flex">
          <a href="#mapa-section" className="hover:text-white">Mapa</a>
          <a href="#lodges-section" className="hover:text-white">Lodges</a>
          <a href="#guias-section" className="hover:text-white">Guías</a>
          <a href="#tarifas" className="hover:text-white">Tarifas</a>
          <a href="#contacto" className="rounded-full bg-white px-4 py-2 font-semibold text-slate-900 transition hover:bg-slate-200">Contacto</a>
        </nav>
      ...
      <div className={`${open ? 'block' : 'hidden'} border-t border-white/10 bg-slate-950/95 md:hidden`}>
        <div className="space-y-1 px-4 py-4 text-sm text-slate-200">
          <a href="#mapa-section" className="block rounded-lg px-3 py-2 hover:bg-white/5">Mapa</a>
          <a href="#lodges-section" className="block rounded-lg px-3 py-2 hover:bg-white/5">Lodges</a>
          <a href="#guias-section" className="block rounded-lg px-3 py-2 hover:bg-white/5">Guías</a>
          <a href="#tarifas" className="block rounded-lg px-3 py-2 hover:bg-white/5">Tarifas</a>
          <a href="#contacto" className="block rounded-lg bg-white px-3 py-2 font-semibold text-slate-900">Contacto</a>
        </div>
      </div>
    </header>
  );
