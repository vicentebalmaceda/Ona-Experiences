        ...
        <div className="mt-8 grid gap-8 lg:grid-cols-[minmax(0,1fr)_370px]">
            ...
            <section className="detail-content-card">
              <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
                <div>
                  ...
                  <p className="mt-3 text-sm leading-6 text-slate-600">Mapa integrado con el mismo punto usado en el directorio.</p>
          ...
          <aside className="booking-panel">
            <div className="booking-panel__inner">
              ...
              <p className="mt-4 text-center text-xs leading-5 text-slate-500">La cotización no confirma reserva automáticamente.</p>
            </div>
          </aside>
        </div>
      </div>
